...
public enum GlobalErrorCode implements ErrorCode {
    ...
    PRESCRIPTION_NOT_FOUND("PRESCRIPTION_NOT_FOUND", "处方不存在"),
    PRESCRIPTION_INVALID_STATE("PRESCRIPTION_INVALID_STATE", "处方状态不允许该操作"),
    PRESCRIPTION_NOT_AUDITABLE("PRESCRIPTION_NOT_AUDITABLE", "当前处方不在待审状态，无法审核"),
    MEDICAL_RECORD_NOT_FOUND("MEDICAL_RECORD_NOT_FOUND", "病历不存在"),
