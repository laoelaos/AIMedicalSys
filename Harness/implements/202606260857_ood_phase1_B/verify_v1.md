...
## 统计
- 通过：48
- 失败：5（1 失败 + 4 错误，均集中在 UserRepositoryTest H2 DDL 预置条件缺失，详见证报告日志）
- 总测试数：53
...
[INFO] Tests run: 9, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.065 s -- in com.aimedical.modules.commonmodule.permission.PostTest
[INFO] Running com.aimedical.modules.commonmodule.permission.RoleTest
[INFO] Tests run: 9, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.013 s -- in com.aimedical.modules.commonmodule.permission.RoleTest
...
2026-06-26T09:26:21.076+08:00  INFO 26220 --- [           main] c.a.m.c.permission.UserRepositoryTest    : Starting UserRepositoryTest using Java 21.0.11 with PID 26220 (started by laoE in C:\Develop\Software\AIMedicalSys\AIMedical\backend\modules\common-module\common-module-impl)
2026-06-26T09:26:21.080+08:00  INFO 26220 --- [           main] c.a.m.c.permission.UserRepositoryTest    : No active profile set, falling back to 1 default profile: "default"
2026-06-26T09:26:21.540+08:00  INFO 26220 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Bootstrapping Spring Data JPA repositories in DEFAULT mode.
2026-06-26T09:26:21.606+08:00  INFO 26220 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Finished Spring Data repository scanning in 55 ms. Found 4 JPA repository interfaces.
2026-06-26T09:26:21.666+08:00  INFO 26220 --- [           main] beddedDataSourceBeanFactoryPostProcessor : Replacing 'dataSource' DataSource bean with embedded version
2026-06-26T09:26:21.875+08:00  INFO 26220 --- [           main] o.s.j.d.e.EmbeddedDatabaseFactory        : Starting embedded database: url='jdbc:h2:mem:ad7ebb5a-57f8-4464-bf72-36f11f4a2cdd;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=false', username='sa'
2026-06-26T09:26:22.184+08:00  INFO 26220 --- [           main] o.hibernate.jpa.internal.util.LogHelper  : HHH000204: Processing PersistenceUnitInfo [name: default]
2026-06-26T09:26:22.257+08:00  INFO 26220 --- [           main] org.hibernate.Version                    : HHH000412: Hibernate ORM core version 6.4.4.Final
2026-06-26T09:26:22.291+08:00  INFO 26220 --- [           main] o.h.c.internal.RegionFactoryInitiator    : HHH000026: Second-level cache disabled
2026-06-26T09:26:22.561+08:00  INFO 26220 --- [           main] o.s.o.j.p.SpringPersistenceUnitInfo      : No LoadTimeWeaver setup: ignoring JPA class transformer
2026-06-26T09:26:22.620+08:00  WARN 26220 --- [           main] org.hibernate.orm.deprecation            : HHH90000025: H2Dialect does not need to be specified explicitly using 'hibernate.dialect' (remove the property setting and it will be selected by default)
2026-06-26T09:26:23.664+08:00  INFO 26220 --- [           main] o.h.e.t.j.p.i.JtaPlatformInitiator       : HHH000489: No JTA platform available (set 'hibernate.transaction.jta.platform' to enable JTA platform integration)
Hibernate: 
...
2026-06-26T09:26:23.706+08:00  WARN 26220 --- [           main] o.h.t.s.i.ExceptionHandlerLoggedImpl     : GenerationTarget encountered exception accepting command : Error executing DDL "
    create table sys_user (
        deleted boolean not null,
        enabled boolean not null,
        password_change_required BIT(1) DEFAULT 0 not null,
...
Hibernate: 
    alter table if exists user_post 
       ...
       foreign key (user_id) 
       references sys_user
2026-06-26T09:26:23.733+08:00  WARN 26220 --- [           main] o.h.t.s.i.ExceptionHandlerLoggedImpl     : GenerationTarget encountered exception accepting command : Error executing DDL "
    alter table if exists user_post 
       add constraint FKafwurpfqy3g4a4k0xnse3l8vy 
       foreign key (user_id) 
...
Hibernate: 
    alter table if exists user_role 
       ...
       foreign key (user_id) 
       references sys_user
2026-06-26T09:26:23.737+08:00  WARN 26220 --- [           main] o.h.t.s.i.ExceptionHandlerLoggedImpl     : GenerationTarget encountered exception accepting command : Error executing DDL "
    alter table if exists user_role 
       add constraint FKsrs64lo4ci4xyu3da9clbiv8r 
       foreign key (user_id) 
       references sys_user" via JDBC [Table "SYS_USER" not found;]
...
2026-06-26T09:26:23.741+08:00  INFO 26220 --- [           main] j.LocalContainerEntityManagerFactoryBean : Initialized JPA EntityManagerFactory for persistence unit 'default'
2026-06-26T09:26:24.216+08:00  INFO 26220 --- [           main] c.a.m.c.permission.UserRepositoryTest    : Started UserRepositoryTest in 3.539 seconds (process running for 4.764)
Hibernate: 
    select
        u1_0.id,
        u1_0.created_at,
    ...
    where
        u1_0.username=?
2026-06-26T09:26:24.893+08:00  WARN 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : SQL Error: 42102, SQLState: 42S02
2026-06-26T09:26:24.893+08:00 ERROR 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : Table "SYS_USER" not found; SQL statement:
...
Hibernate: 
    ...
    values
        (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, default)
2026-06-26T09:26:24.978+08:00  WARN 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : SQL Error: 42102, SQLState: 42S02
2026-06-26T09:26:24.978+08:00 ERROR 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : Table "SYS_USER" not found; SQL statement:
...
Hibernate: 
    ...
    values
        (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, default)
2026-06-26T09:26:24.988+08:00  WARN 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : SQL Error: 42102, SQLState: 42S02
2026-06-26T09:26:24.989+08:00 ERROR 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : Table "SYS_USER" not found; SQL statement:
insert into sys_user (created_at,deleted,email,enabled,nickname,password,password_change_required,phone,token_version,updated_at,user_type,username,id) values (?,?,?,?,?,?,?,?,?,?,?,?,default) [42102-224]
Hibernate: 
    insert 
    into
    ...
    values
        (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, default)
2026-06-26T09:26:25.002+08:00  WARN 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : SQL Error: 42102, SQLState: 42S02
2026-06-26T09:26:25.003+08:00 ERROR 26220 --- [           main] o.h.engine.jdbc.spi.SqlExceptionHelper   : Table "SYS_USER" not found; SQL statement:
insert into sys_user (created_at,deleted,email,enabled,nickname,password,password_change_required,phone,token_version,updated_at,user_type,username,id) values (?,?,?,?,?,?,?,?,?,?,?,?,default) [42102-224]
[ERROR] Tests run: 9, Failures: 1, Errors: 4, Skipped: 0, Time elapsed: 4.690 s <<< FAILURE! -- in com.aimedical.modules.commonmodule.permission.UserRepositoryTest
[ERROR] com.aimedical.modules.commonmodule.permission.UserRepositoryTest.shouldFindByUsernameReturnEmptyWhenNotFound -- Time elapsed: 0.683 s <<< ERROR!
...
select u1_0.id,u1_0.created_at,u1_0.deleted,u1_0.email,u1_0.enabled,u1_0.nickname,u1_0.password,u1_0.password_change_required,u1_0.phone,u1_0.token_version,u1_0.updated_at,u1_0.user_type,u1_0.username from sys_user u1_0 where u1_0.username=? [42102-224]] [select u1_0.id,u1_0.created_at,u1_0.deleted,u1_0.email,u1_0.enabled,u1_0.nickname,u1_0.password,u1_0.password_change_required,u1_0.phone,u1_0.token_version,u1_0.updated_at,u1_0.user_type,u1_0.username from sys_user u1_0 where u1_0.username=?]; SQL [select u1_0.id,u1_0.created_at,u1_0.deleted,u1_0.email,u1_0.enabled,u1_0.nickname,u1_0.password,u1_0.password_change_required,u1_0.phone,u1_0.token_version,u1_0.updated_at,u1_0.user_type,u1_0.username from sys_user u1_0 where u1_0.username=?]
	...
	at jdk.proxy2/jdk.proxy2.$Proxy134.findByUsername(Unknown Source)
...
[ERROR] com.aimedical.modules.commonmodule.permission.UserRepositoryTest.shouldPersistWithValidPassword -- Time elapsed: 0.056 s <<< ERROR!
...
[ERROR] com.aimedical.modules.commonmodule.permission.UserRepositoryTest.shouldHaveNotNullConstraintOnPasswordColumn -- Time elapsed: 0.025 s <<< ERROR!
...
[INFO] Tests run: 15, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.014 s -- in com.aimedical.modules.commonmodule.permission.UserTest
...
2026-06-26T09:26:25.646+08:00  WARN 26220 --- [           main] c.a.modules.commonmodule.jwt.JwtUtil     : JWT���Ƹ�ʽ����: Invalid compact JWT string: Compact JWSs must contain exactly 2 period characters, and compact JWEs must contain exactly 4.  Found: 0
[INFO] Tests run: 3, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.986 s -- in com.aimedical.modules.commonmodule.service.AuthServiceTest$GetCurrentUserTests
[INFO] Running com.aimedical.modules.commonmodule.service.AuthServiceTest$RefreshTokenTests
2026-06-26T09:26:26.127+08:00  WARN 26220 --- [           main] c.a.modules.commonmodule.jwt.JwtUtil     : JWT���Ƹ�ʽ����: Invalid compact JWT string: Compact JWSs must contain exactly 2 period characters, and compact JWEs must contain exactly 4.  Found: 0
[INFO] Tests run: 3, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.226 s -- in com.aimedical.modules.commonmodule.service.AuthServiceTest$RefreshTokenTests
[INFO] Running com.aimedical.modules.commonmodule.service.AuthServiceTest$LogoutTests
2026-06-26T09:26:26.352+08:00  INFO 26220 --- [           main] c.a.m.c.service.impl.AuthServiceImpl     : �û��ǳ�
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.071 s -- in com.aimedical.modules.commonmodule.service.AuthServiceTest$LogoutTests
[INFO] Running com.aimedical.modules.commonmodule.service.AuthServiceTest$LoginTests
2026-06-26T09:26:26.426+08:00  WARN 26220 --- [           main] c.a.m.c.service.impl.AuthServiceImpl     : ��¼ʧ�ܣ��û��ѱ����ã��û���: testuser
2026-06-26T09:26:26.565+08:00  INFO 26220 --- [           main] c.a.m.c.service.impl.AuthServiceImpl     : �û���¼�ɹ����û���: testuser
2026-06-26T09:26:26.633+08:00  WARN 26220 --- [           main] c.a.m.c.service.impl.AuthServiceImpl     : ��¼ʧ�ܣ��û������ڣ��û���: nonexistent
2026-06-26T09:26:26.769+08:00  WARN 26220 --- [           main] c.a.m.c.service.impl.AuthServiceImpl     : ��¼ʧ�ܣ���������û���: testuser
[INFO] Tests run: 4, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.414 s -- in com.aimedical.modules.commonmodule.service.AuthServiceTest$LoginTests
[INFO] Tests run: 0, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1.712 s -- in com.aimedical.modules.commonmodule.service.AuthServiceTest
[INFO] 
[INFO] Results:
[INFO] 
[ERROR] Failures: 
...
insert into sys_user (created_at,deleted,email,enabled,nickname,password,password_change_required,phone,token_version,updated_at,user_type,username,id) values (?,?,?,?,?,?,?,?,?,?,?,?,default) [42102-224]] [insert into sys_user (created_at,deleted,email,enabled,nickname,password,password_change_required,phone,token_version,updated_at,user_type,username,id) values (?,?,?,?,?,?,?,?,?,?,?,?,default)]
[INFO] 
[ERROR] Tests run: 53, Failures: 1, Errors: 4, Skipped: 0
[INFO] 
[INFO] ------------------------------------------------------------------------
[INFO] BUILD FAILURE
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  9.519 s
[INFO] Finished at: 2026-06-26T09:26:26+08:00
[INFO] ------------------------------------------------------------------------
