...
**模块间依赖规则**：
- `common`：依赖 Spring Boot Starter 基础库及 spring-boot-starter-security（用于 SecurityConfig），所有模块可依赖它
...
DESIGN_WRITTEN:C:\Develop\Software\AIMedicalSys\Harness\redeliberations\202606151714_Phase0_OOD\a_v6_design_v1.md
