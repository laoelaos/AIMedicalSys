...
第四阶段（集成测试）: mvn verify -pl integration -DskipTests（运行集成测试，含 Failsafe 插件；-DskipTests 为 Maven 标准属性，跳过 Surefire 单元测试，不影响 Failsafe 集成测试执行）
...
DESIGN_WRITTEN:C:\Develop\Software\AIMedicalSys\Harness\redeliberations\202606151714_Phase0_OOD\a_v11_design_v1.md
