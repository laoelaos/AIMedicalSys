...
20 个测试相关事项中：
- **T5、T21、T22、T24、T25、T30、T33** — 测试设计/实现质量问题（共 7 项）
...
P1 ── T11 ──→ T17（T11 的 SecurityContext 使用方式与 T17 的插值管线覆盖同属 Filter/Handler 层）
       │
       T12/T13/T15/T18/T19 ──→ 无交叉依赖，可并行
       │
       T5/T6/T7 ──→ 与被测代码修复批独立，可先行或并行

P2 ── T3/T4/T8/T10/T16/T20-T34 ──→ 无交叉依赖，可任意顺序
```
